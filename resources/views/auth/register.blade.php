...
<body class="bg-dark">
    ...
    <div class="container-sm d-flex justify-content-center mt-3">
        <div class="card bg-custom p-5" style="width: 30rem"> 
            <h2 style="text-align:center; color:white" class="mt-3">Register</h2>
            <form action="{{route('login')}}" class="p-3" method="post">
                ...
                <div class="d-flex justify-content-center">
                 <button class="btn btn-light my-3">Register</button>
                </div>
            </form>
            ...
            <medium class="text-decoration-none text-dark" style="text-align: center">Already have an account?</medium>  
            <a class="text-dark hover-white" style="text-align: center" href="login">Login</a> 
            </div>      
        </div>     
    </div>
</body>
